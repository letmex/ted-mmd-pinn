...
PFF_model_dict = {"PFF_model" : 'AT1', "se_split" : None, "tol_ir" : 5e-3}
...
loading_angle = torch.tensor([0])
disp = np.concatenate((np.linspace(0.0, 0.21, 8), np.linspace(0.24, 0.40, 33)), axis=0)
disp = disp[1:]
